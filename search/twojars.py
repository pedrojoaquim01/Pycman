...
class TwoJarsState:
    ...
    def legalMoves( self ):
        ...
        if j3 == 0 or j3 < 3:
            acoes_legais.append('fillJ3')
        if j3 != 0:
            acoes_legais.extend(['emptyJ3','pourJ3intoJ4'])
        if j4 == 0 or j4 < 4:
            acoes_legais.append('fillJ4')
        if j4 != 0:
            acoes_legais.extend(['emptyJ4','pourJ4intoJ3'])
    ...
    def __getAsciiString(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        texto = 'Jarro de 4L = ' + str(self.jars[0]) + '\nJarro de 3L = ' + str(self.jars[1]) 
